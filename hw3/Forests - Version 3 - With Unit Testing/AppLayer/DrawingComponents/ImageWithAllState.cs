...
namespace AppLayer.DrawingComponents
{
    ...
    /// class represent a "whole" image that combines both intrinsic state part and the extrinsic state part.
    /// Objects of this class only need to exist for short period time, like a drawing session.
    /// 
    /// For the decorator pattern, this class is a Decorator.  It add the extrinsic state to ImageWithIntrinsic State objects
    /// </summary>
    public class ImageWithAllState : Image
    {
        internal ImageWithIntrinsicState IntrinsicState { get; }
        public ImageExtrinsicState ExtrinsicStatic { get; }

        internal ImageWithAllState(ImageWithIntrinsicState sharedPart, ImageExtrinsicState nonsharedPart)
        {
